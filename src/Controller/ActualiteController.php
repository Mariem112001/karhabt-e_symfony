...
class ActualiteController extends AbstractController
{
    ...
    public function new(SecurityController $security,Request $request, ActualiteRepository $actualiteRepository, EntityManagerInterface $entityManager, SluggerInterface $slugger): Response
    {
